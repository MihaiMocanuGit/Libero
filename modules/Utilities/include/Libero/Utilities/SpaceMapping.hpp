...
{
// NOTE: This is mostly a personal experiment, as I wanted to construct the needed logic for space
// projections in an abstract setting. I didn't follow the usual 3d to 2d projection
// formulas, as I wanted to see if I can built this from scratch, without relying on formulas
// derived by somebody else.
// Considering this was designed as CPU logic, they aren't really of any tangible help in a real use
// case.
//
//
/**
